...
SPO OFF;
HOS zip -q &&main_compressed_filename._&&file_creation_time. &&eadam36_log..txt
...
-- execute one sql
@@&&skip_html.&&html_reports.eadam36_9b_one_html.sql
@@&&skip_text.&&text_reports.eadam36_9c_one_text.sql
@@&&skip_csv.&&csv_files.eadam36_9d_one_csv.sql
